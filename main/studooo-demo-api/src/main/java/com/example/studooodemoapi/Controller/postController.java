...
public class postController {
    ...
    @GetMapping
    public ResponseEntity<List<Posts>> getPosts(@RequestParam(required = false) int postId, @RequestBody(required = false) regularUser user) {
        return new ResponseEntity<>(regularUserService.getPosts(postId, user), HttpStatus.OK);
    }
